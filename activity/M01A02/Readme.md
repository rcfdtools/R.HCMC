...
<div align="center"><img src="graph/M01A02.png" alt="R.HCMC" width="60%" border="0" /></div>
...
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [🧰Herramienta](https://www.microsoft.com/es/microsoft-365/excel?market=bz)                                                                                       | Microsoft Excel                                                                                                                                                                                                                                                                               |
| [🧰Herramienta](https://notepad-plus-plus.org/)                                                                                                                   | Notepad++                                                                                                                                                                                                                                                                                     |
| [🧰Herramienta](https://qgis.org/)                                                                                                                                | QGIS 3.44 o superior                                                                                                                                                                                                                                                                          |
| [🧰Herramienta](https://www.hec.usace.army.mil/software/hec-hms/)                                                                                                 | HEC-HMS 4.13 o superior                                                                                                                                                                                                                                                                       |
| [🧰Herramienta](https://www.hec.usace.army.mil/software/hec-dssvue/)                                                                                              | HEC-DSSVue 3.2.3 (versión funcional para cargue masivo de hietogramas)                                                                                                                                                                                                                        |
| [📓Lectura](https://github.com/rcfdtools/R.HydroTools/blob/main/tool/FactorAtenuacionPrecipitacionFa/R.HydroTools.FactorAtenuacionPrecipitacionFa.pdf)            | Factor de atenuación hidrológica de la precipitación por área simultánea                                                                                                                                                                                                                      |
| [📂HECHMS_v0.zip](../../file/hec/HECHMS_v0.zip)                                                                                                                   | Modelo hidrológico HEC-HMS con topología de áreas de drenaje de aproximadamente 4 km² o superior, compuesto por 44 subcuencas, 41 tramos de drenaje de 151.6 km (21 corresponden a tramos con tránsito hidrológico), área total de la cuenca en estudio: 247.1 km²                            |
| [📅 R.HydroTools.FactorAtenuacion PrecipitacionFa.xlsx](https://github.com/rcfdtools/R.HydroTools/tree/main/tool/FactorAtenuacionPrecipitacionFa)                 | Libro de cálculo para la estimación del Fa - Factor de atenuación de la precipitación máxima por área simultánea en una cuenca                                                                                                                                                                |
| [📅 Hietogramas](../../file/table/Hietogramas)                                                                                                                    | Archivos con series de hietogramas para diferentes periodos de retorno y factores de atenuación (0.62, 0.63, 0.64, 1) en función de las áreas acumuladas hasta los puntos de inicio, entrega y cauces menores. Incluye hietogramas para periodos de retorno de 2.33, 5, 10, 25, 50 y 100 años |
| [📅 R.HCMC.PuntoEstudio.xlsx](../../file/table/R.HCMC.PuntoEstudio.xlsx)                                                                                          | Puntos de estudio y factores de atenuación aplicados                                                                                                                                                                                                                                          |
...
| [📅 R.HydroTools.Hidrograma RegVal.xlsm](https://github.com/rcfdtools/R.HydroTools/tree/main/tool/HidrogramaRegVal)                                               | Libro de cálculo para el registro y validación de hidrogramas obtenidos a partir de modelación hidrológica en HEC-HMS                                                                                                                                                                         |
| [🗺️Grillas para balance hidrológico](../../file/grid)                                                                                                            | Grillas de precipitación media y evapotranspiración real requeridas para la estimación de caudales medios de largo plazo                                                                                                                                                                      |
| [📌Cuencas agregadas balance hidrológico](../../file/shp)                                                                                                         | Grillas de precipitación media y evapotranspiración real requeridas para la estimación de caudales medios de largo plazo                                                                                                                                                                      |
</div>
...
<div align="center"><img src="graph/R.HydroTools.FactorAtenuacion PrecipitacionFa1.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.FactorAtenuacion PrecipitacionFa2.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/MicrosoftWindows_ControlPanelCustomizeFormat.jpg" alt="R.HCMC" width="40%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_ConvertProject.jpg" alt="R.HCMC" width="60%" border="0" /></div>
...
<div align="center"><sub>Modelo topológico de subcuenca</sub><br><img src="graph/HECHMS_BasinModel.jpg" alt="R.HCMC" width="100%" border="0" /></div>
<div align="center"><sub>Área por subcuenca</sub><br><img src="graph/HECHMS_SubbasinArea.jpg" alt="R.HCMC" width="100%" border="0" /></div>
<div align="center"><sub>Pérdidas / Número de curva CN del SCS por subcuenca</sub><br><img src="graph/HECHMS_LossSCSCurveNumber.jpg" alt="R.HCMC" width="100%" border="0" /></div>
<div align="center"><sub>Transformación / Hidrograma unitario del SCS por subcuenca</sub><br><img src="graph/HECHMS_TransformSCSUnitHydrograph.jpg" alt="R.HCMC" width="100%" border="0" /></div>
<div align="center"><sub>Tránsito hidrológico / Muskingum por drenaje</sub><br><img src="graph/HECHMS_RoutingMuskingum.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
* Identifique la subcuenca o subcuencas correspondientes al (los) cauce (s) lateral (es) que drenarán sus aguas al canal a diseñar y establezca el factor de atenuación. Para cuencas laterales menores o iguales a 25 km², suponga que el centro de tormenta cubre toda esta cuenca menor.
...
<div align="center"><sub>Tránsito hidrológico / Muskingum por drenaje</sub><br><img src="graph/HECHMS_GlobalSummaryResults.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_ProjectPropertiesCRS.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_NodoEjeValleGIS.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_NodoEjeValleGISConvertCSV.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_R.HCMC.NodoValleShp.jpg" alt="R.HCMC" width="100%" border="0" /></div>

Simbolice los nodos por categorías a partir del código del eje y rotule con la expresión  `"Eje"  || '-'  ||   "Nodo" `

<div align="center"><img src="graph/QGIS_R.HCMC.NodoValle.shpSymbol.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_MapLayersAdd.jpg" alt="R.HCMC" width="100%" border="0" /></div>
<div align="center"><img src="graph/HECHMS_MapLayersAdd1.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECDSS_OpenDSSFile.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
> Tenga en cuenta que antes de importar un nuevo archivo de datos, deberá eliminar todos los registros existentes en la base de datos HEC-DSS y luego purgar la base de datos mediante la opción _Tools – Squeeze_.

<div align="center"><img src="graph/HECDSS_SelectDelete.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECDSS_DataEntryImportTimeSeriesData.jpg" alt="R.HCMC" width="100%" border="0" /></div>
<div align="center"><img src="graph/HECDSS_DataEntryImportTimeSeriesData1.jpg" alt="R.HCMC" width="100%" border="0" /></div>

Seleccione y visualice la gráfica de algunos de los hietogramas importados.

<div align="center"><img src="graph/HECDSS_DataEntryImportTimeSeriesData2.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/Notepad_ArroyoElZorroGage.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_ControlSpecifications.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_Run.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_JunctionJ4660.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_JunctionJ4660RunGlobalSummary.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_JunctionJ4660RunGraph.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/HECHMS_JunctionJ4660RunTimeSeriesResults.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.Results1.jpg" alt="R.HCMC" width="80%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.Results2.jpg" alt="R.HCMC" width="80%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.Results3.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.J4660a.jpg" alt="R.HCMC" width="90%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.J4660b.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.J4682a.jpg" alt="R.HCMC" width="90%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.J4682b.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.W19610Fa1a.jpg" alt="R.HCMC" width="90%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.W19610Fa1b.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.W19610Fa063a.jpg" alt="R.HCMC" width="90%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.W19610Fa063b.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.Sink1a.jpg" alt="R.HCMC" width="90%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.Sink1b.jpg" alt="R.HCMC" width="70%" border="0" /></div>
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.Sink1c.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_ZonalStatisticCuencaHastaJ4660PMedCsv.jpg" alt="R.HCMC" width="90%" border="0" /></div>
<div align="center"><img src="graph/QGIS_ZonalStatisticCuencaHastaJ4660PMedCsv1.jpg" alt="R.HCMC" width="90%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.HidrogramaRegVal.ResultsQm.jpg" alt="R.HCMC" width="80%" border="0" /></div>
...
Libro de revisión y calificación de proyecto: [M01A02_PuntoEstudioCaudales.xlsx](M01A02_PuntoEstudioCaudales.xlsx). En el libro de registro de resultados, registrar los valores en el mismo orden definido en la tabla de revisión, correspondiente a: J4685, SINK-1, J4660, R19120 + W19690 (Fa 0.96), R19120 + W19690 (Fa 0.64), J4682, W19610 (Fa 1.00), W19610 (Fa 0.63), W19560, W19520.

En la siguiente tabla se listan las actividades que deben ser desarrolladas y documentadas por cada estudiante o grupo de proyecto.

| Actividad | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|:----------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| M01A02    | 👤👥 Identificar y registrar en el libro de Excel suministrado [R.HCMC.PuntoEstudio.xlsx](../../file/table/R.HCMC.PuntoEstudio.xlsx), los puntos de estudio del proyecto final y definir las áreas de aportación. Guardar en la carpeta _/file/table_.                                                                                                                                                                                                                                                                                                | 
| M01A02    | 👤👥 Crear la capa geográfica shapefile de localización de puntos de estudio, nombrar como _R.HCMC.PuntoEstudio.shp_. Completar y usar el libro [R.HCMC.PuntoEstudio.xlsx](../../file/table/R.HCMC.PuntoEstudio.xlsx). Tenga en cuenta que los puntos de estudio corresponden a las localizaciones específicas donde serán obtenidos los hidrogramas y caudales pico del caso de estudio o del proyecto.                                                                                                                                              | 
...
| M01A02    | 👥 En una tabla y al final del informe técnico de esta entrega, indique el detalle de las actividades realizadas por cada integrante de su grupo; utilice las siguientes columnas: `Nombre del integrante`, `Actividades realizadas`, `Tiempo dedicado en horas` (si presenta la entrega individualmente, no es necesaria la presentación de esta tabla).<br><br>👤 Para actividades que no requieren del desarrollo de elementos de avance, indicar si realizo la lectura de la guía de clase y las lecturas indicadas al inicio en los requerimientos. | 
...
| [◄ Anterior](../M01A01/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/1) | [Siguiente ►](../M01A03/Readme.md) |
|--------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------|
