...
1. Desde el menu _Project_, seleccionar la opción _Import/Export / Export Project to DXF_, seleccionar las capas de drenajes, eje suavizado del valle, curvas de nivel y opcionalmente las aristas del modelo triangulado. Guardar como _/file/cad/acad/DTM_QGISVectoresTerrenoNatural_v0.dxf_
...
Libro de revisión y calificación de proyecto:  [M01A04_MDT.xlsx](M01A04_MDT.xlsx)
...
| M01A04    | 👤👥 Crear el modelo de terreno triangulado TIN en formato vectorial D2M y convertir a raster .tif con resolución 0.5 metros. Guardar como /file/dem/TIN_TerrenoNaturalQGIS_v0.d2m                                                                                                                                                                                                                                                                                                                                                                                                                | 
| M01A04    | 👤👥 Con la herramienta _Processing Toolbox / Layer Tools / Extract layer extent_, obtenga el polígono regular rectangular de la extensión de la capa geográfica de curvas de nivel. Guarde como [/file/shp/CGG_CurvaNivelLidarExtent_v0.shp](../../file/shp/CGG_CurvaNivelLidarExtent_v0.zip)                                                                                                                                                                                                                                                             | 
...
| [◄ Anterior](../M01A03/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/1) | [Siguiente ►](../M01A05/Readme.md) |
|--------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------|
