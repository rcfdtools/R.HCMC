...
## 5. Generación automática de secciones transversales en RAS Mapper
...
Libro de revisión y calificación de proyecto:  [M01A05_HECRASSample.xlsx](M01A05_HECRASSample.xlsx)
...
| M01A05    | 👥 argar en la carpeta _/file/hec_ del repositorio de datos, el archivo comprimido del modelo RAS como [HECRAS_v0.zip](../../file/hec).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 
...
| [◄ Anterior](../M01A04/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/1) | [Siguiente ►](../M01A06/Readme.md) |
|--------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------|
