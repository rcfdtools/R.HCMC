...
| [📅R.HydroTools. TaludReferenciaCanal.xlsx](https://github.com/rcfdtools/R.HydroTools/tree/main/tool/TaludReferenciaCanal) | Libro de cálculo para la evaluación de taludes de referencia para diseño de sección a partir de secciones transversales de cauces naturales. |
...
Libro de revisión y calificación de proyecto:  [M01A09_TaludRef.xlsx](M01A09_TaludRef.xlsx)
...
| M01A09    | 👥 Opcional: Investigar criterios técnicos para la definición de la relación de taludes en cauces dominantes y en valles o zonas de creciente. Incluir referencias técnicas detalladas.                                                                                                                                                                                                                                                                                                                                                                    |
| M01A09    | 👥 Opcional: registrar los valores obtenidos en el [libro de parámetros generales](https://github.com/rcfdtools/R.HydroTools/tree/main/tool/DisenoCaucesParametros) requeridos para el diseño y la modelación. Guardar en la carpeta _/file/table_.                                                                                                                                                                                                                                                                                                        |
...
| [◄ Anterior](../M01A08/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/1) | [Siguiente ►](../M01A10/Readme.md) |
|--------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------|
