...
<div align="center"><img src="graph/M01A19.jpg" alt="R.HCMC" width="60%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.1.jpg" alt="R.HCMC" width="75%" border="0" /></div>

3. Verifique la altura de caída y que se cumplan los criterios de selección de altura de contrahuella.

<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.2.jpg" alt="R.HCMC" width="75%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.3.jpg" alt="R.HCMC" width="75%" border="0" /></div>

5. Revise el cálculo de la profundidad y la velocidad de flujo, si se alcanza la condición de flujo quasi-uniforme.

<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.4.jpg" alt="R.HCMC" width="75%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.5.jpg" alt="R.HCMC" width="75%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.6.jpg" alt="R.HCMC" width="75%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.7.jpg" alt="R.HCMC" width="75%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.8.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/R.HydroTools.DisenoEstructuraEscalonadaFlujoRasante.9.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_DeleteDuplícateGeometries.jpg" alt="R.HCMC" width="70%" border="0" /></div>
<div align="center"><img src="graph/QGIS_DeleteDuplícateGeometries1.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_TINMeshCreation1.jpg" alt="R.HCMC" width="70%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_SaveVectorLayerAsDxf.jpg" alt="R.HCMC" width="60%" border="0" /></div>

Agregue las entidades DXF al mapa y verifique su localización.

<div align="center"><img src="graph/QGIS_AddLayerDxf.jpg" alt="R.HCMC" width="65%" border="0" /></div>
<div align="center"><img src="graph/QGIS_AddLayerDxf1.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/Civil3D_OpenDxf.jpg" alt="R.HCMC" width="100%" border="0" /></div>

9. Guarde el archivo DXF como un archivo de AutoCAD como /file/cad/acad/DisenoEstructuraEscalonadaFlujoRasanteGIS.dwg.

<div align="center"><img src="graph/Civil3D_SaveAsDwg.jpg" alt="R.HCMC" width="70%" border="0" /></div>

10. En el panel lateral _TOOLSPACE_, de clic derecho en _Surfaces_ y seleccione _Create Surface_. 

<div align="center"><img src="graph/Civil3D_CreateSurface.jpg" alt="R.HCMC" width="100%" border="0" /></div>

11. En _Definition_, seleccione la opción _Drawing Object_, de clic derecho y seleccione _Add..._.

<div align="center"><img src="graph/Civil3D_CreateSurfaceDefinition.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/Civil3D_CreateSurfaceDefinitionAdd.jpg" alt="R.HCMC" width="100%" border="0" /></div>

Podrá observar un polígono de contorno que indica que la superficie ha sido creada.

<div align="center"><img src="graph/Civil3D_CreateSurfaceDefinitionAdd1.jpg" alt="R.HCMC" width="100%" border="0" /></div>

13. En el menú _View_, active la vista _Conceptual_ y con el comando _3DORBIT_, rote la visualización 3D.

<div align="center"><img src="graph/Civil3D_3DOrbit.jpg" alt="R.HCMC" width="100%" border="0" /></div>

Acérquese y visualice los escalones de la estructura.

<div align="center"><img src="graph/Civil3D_3DOrbit1.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/Civil3D_SurfaceSelect.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/Civil3D_ExtractObjects.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/Civil3D_SaveDrawingAsDxf.jpg" alt="R.HCMC" width="100%" border="0" /></div>

17. En QGIS, cargue solo las entidades del archivo de la superficie triangulada generada en Civil 3D.

<div align="center"><img src="graph/QGIS_AddLayerCivil3DEntities.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_TINMeshCreation2.jpg" alt="R.HCMC" width="100%" border="0" /></div>

> Este procedimiento se ejecutará correctamente en QGIS, debido a que crearemos la superficie desde triangulos 3D.

<div align="center"><img src="graph/QGIS_TINMeshCreation3.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_RasterizeMeshDataset.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
<div align="center"><img src="graph/QGIS_ElevationProfile4.jpg" alt="R.HCMC" width="100%" border="0" /></div>
...
| [:arrow_backward: Anterior](../M01A18/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/99999) | [Siguiente :arrow_forward:](../M01A20/Readme.md) |
|--------------------------------------------------|-----------------------------------|--------------------------------------------------------------------------------------|--------------------------------------------------|
