...
**_Nota 3_**: en el documento .pdf indicar sí a partir del análisis del modelo de terreno integrado, son requeridos diques de encausamiento en inicio y de protección en entrega.

**_Nota 4_**: para la revisión y calificación del modelo topológico se verificará
