...
| Actividad | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:----------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| M03A03    | En el modelo hidráulico depurado [HECRAS_v1](../../file/hec), incorpore las condiciones de frontera definidas en esta actividad para su proyecto para los periodos de retorno considerados en su diseño, además de las indicaciones descritas en la _Nota 3_.                                                                                                                                                                                                                                                                                        |  
