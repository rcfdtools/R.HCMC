...
Keywords: `hec-ras` `ras-mapper` `hydraulic-model` `cross-section` `boundary-condition` `m03a02`
...
| Actividad | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:----------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| M03A03    | En el modelo hidráulico depurado [/file/hec/HECRAS_v1](../../file/hec), incorpore las condiciones de frontera definidas en esta actividad, además de las indicaciones descritas en la _Nota 3_.                                                                                                                                                                                                                                                                                                                                                     |  
...
* En el modelo /file/hec/HECRAS_v1 depurado en la entrega anterior, asignar las rugosidades en zona central del cauce dominante y valle. Utilizar los valores con los cuales realizó todo el diseño hidráulico de su proyecto en el Módulo 1.
