...
| [📂Modelo hidráulico HECRAS_v1](../../file/hec)                                                         | Modelo hidráulico unidimensional HEC-RAS v1 depurado con inclusión de diques, condiciones de frontera y modelación, completado, ajustado y complementado en actividad [M03A06](../M03A06/Readme.md). |
...
Libro de revisión y calificación de proyecto: [M03A07_RectificacionFondo.xlsx](M03A07_RectificacionFondo.xlsx)

En la siguiente tabla se listan las actividades que deben ser desarrolladas y documentadas por cada estudiante o grupo de proyecto.

| Actividad | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:----------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| M03A07    | 👤👥 Dentro del modelo hidráulico funcional en el que se rectificaron fondos en cauces naturales con Pilot Channel y en RAS Mapper, crear y visualizar el modelo de terreno. En el reporte único, incluir esquemas de planta del MDT con simbología de rampa dinámica en 8 o 32 clases.                                                                                                                                                                                                                                                                   |
...
| [◄ Anterior](../M03A06/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/1) | [Siguiente ►](../M03A08/Readme.md) |
|---------------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------|---------------------------------------------------|
