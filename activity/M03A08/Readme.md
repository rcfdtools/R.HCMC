...
| [:open_file_folder:Modelo hidráulico HECRAS_v1a](../../file/hec)                                   | Modelo hidráulico unidimensional HEC-RAS v1a depurado con inclusión de diques, condiciones de frontera y modelación, y con ajuste de fondo con Pilot Channel en actividad [M03A08](../M03A08/Readme.md). |
...
| Actividad  | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:-----------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| M03A08     | Dentro del modelo hidráulico funcional en el que se rectificaron fondos en cauces naturales con Pilot Channel y en RAS Mapper, crear y visualizar el modelo de terreno. En el reporte único, incluir esquemas de planta del MDT con simbología de rampa dinámica en 8 o 32 clases.                                                                                                                                                                                                                                                                   |  
...
| M03A08     | En el documento soporte muestre capturas de pantalla detalladas de las actividades desarrolladas. Incluir cabecera, tabla de contenido, numeración de páginas y observaciones detalladas.                                                                                                                                                                                                                                                                                                                                                            |  
