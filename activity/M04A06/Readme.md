...
<div align="center"><img src="graph/M04A06.png" alt="R.HCMC" width="60%" border="0" /></div>


## Objetivos

* Realizar la configuración general para la ejecución del modelo.
* Configurar los intervalos de tiempo variables basados en la Condición de Courant.
* Definir el sistema de ecuaciones para resolver el modelo hidráulico: Saint Venant completo u Onda Difusiva.
* Establecer la configuración del Efecto Coriolis para considerar el efecto rotacional de la tierra.
* Ejecutar la modelación hidráulica.
...
R.HCMC se encuentra en proceso de actualización, consulte la versión anterior en el enlace [M04A06.pdf](M04A06.pdf).
...
| Actividad | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|:----------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| M04A06    | No requeridas para esta actividad.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |  
| M04A06    | En una tabla y al final del informe de avance de esta entrega, indique el detalle de las actividades realizadas por cada integrante de su grupo; utilice las siguientes columnas: `Nombre del integrante`, `Actividades realizadas`, `Tiempo dedicado en horas` (si presenta la entrega individualmente, no es necesaria la presentación de esta tabla).<br><br>Para actividades que no requieren del desarrollo de elementos de avance, indicar si realizo la lectura de la guía de clase y las lecturas indicadas al inicio en los requerimientos. | 
...
| [:arrow_backward: Anterior](../M04A05/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/99999) | [Siguiente :arrow_forward:](../M04A07/Readme.md) |
|--------------------------------------------------|-----------------------------------|--------------------------------------------------------------------------------------|---------------------------------------------------|
