...
<div align="center"><img src="graph/M04A07.png" alt="R.HCMC" width="60%" border="0" /></div>


## Objetivos

Generar y analizar los siguientes mapas:

* Profundidad de lámina de agua
* Gradiantes de Conectividad entre Celdas
* Límite de la zona inundada
* Elevación inversa o cota
* Velocidad
* Esfuerzo Cortante
* Número de Courant
* Número de Froude
* Porcentaje de Tiempo Inundado
* Tiempo de Permanencia del Flujo
...
R.HCMC se encuentra en proceso de actualización, consulte la versión anterior en el enlace [M04A07.pdf](M04A07.pdf).
...
| [:arrow_backward: Anterior](../M04A06/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.HCMC/discussions/99999) | [Siguiente :arrow_forward:](../M04A08/Readme.md) |
|---------------------------------------------------|-----------------------------------|--------------------------------------------------------------------------------------|---------------------------------------------------|
